<x-admin-layout>
    <div class="mb-12 md:mb-0 lg:w-3/4">
        <form action="{{ route('landing.store') }}" method="POST" enctype="multipart/form-data">
            ...
            {{-- TextArea input --}}
            <textarea id="tinymce" class="mb-10" name="content">{{ old('content') }}</textarea>
            <div class="relative mb-6" data-twe-input-wrapper-init>
                <div class="error text-red-500">
                    @error('content')
                        {{ $message }}
            ...
            <div class="relative mb-10" data-twe-input-wrapper-init>
                ...
                <select id="place" name="place"
                    ...
                    <option value='' selected>Sehol</option>
                    <option value="header">Fejléc menüben</option>
                    <option value="footer">Lábléc menüben</option>
                    <option value="both">Mindenhol</option>
                </select>
            </div>
            <!-- Add button -->
            <div class="text-center lg:text-left">
                <button type="submit"
                    ...
                    <i class="fa-solid fa-pen-to-square text-xl mb-[-1px] mr-2"></i>Aloldal létrehozása </button>
            </div>
        </form>
    </div>
</x-admin-layout>
