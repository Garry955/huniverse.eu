    ...
    <div class="mb-12 md:mb-0 lg:w-3/4">
        <form action="{{ route('slider.update', $slider->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="text-center lg:text-left">
                <button type="submit"
                    class="inline-block w-1/3 rounded bg-primary px-16 pb-2 pt-3 text-sm font-medium uppercase leading-normal text-white shadow-primary-3 transition duration-150 ease-in-out hover:bg-primary-accent-300 hover:shadow-primary-2 focus:bg-primary-accent-300 focus:shadow-primary-2 focus:outline-none focus:ring-0 active:bg-primary-600 active:shadow-primary-2 dark:shadow-black/30 dark:hover:shadow-dark-strong dark:focus:shadow-dark-strong dark:active:shadow-dark-strong"
        ...
        <div class="text-center lg:text-left">
            <form action="{{ route('slider.destroy', $slider->id) }}" method="POST">
                ...
                @method('delete')
                <button type="submit"
                    class="inline-block w-1/3 rounded bg-red-500 text-center px-7 py-2 mt-5 text-sm font-medium uppercase leading-normal text-white shadow-primary-3 transition duration-150 ease-in-out hover:bg-red-600 hover:shadow-primary-2 focus:bg-red-accent-300 focus:shadow-primary-2 focus:outline-none focus:ring-0 active:shadow-primary-2 dark:shadow-black/30 dark:hover:shadow-dark-strong dark:focus:shadow-dark-strong dark:active:shadow-dark-strong"
                    data-twe-ripple-init data-twe-ripple-color="light">
                    Dia törlése
                </button>
            </form>
