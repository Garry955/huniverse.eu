          ...
          <div
            ...
            <div class="flex flex-wrap items-center">
              <div class="hidden shrink-0 grow-0 basis-auto lg:flex lg:w-6/12 xl:w-4/12">
                <img src="{{ $product->image ? asset($product->image) : asset('images/no-image.png') }}" alt="Trendy Pants and Shoes"
                ...
                <div class="px-6 py-12 md:px-12 relative">
                  ...
                  <span class="text-right block font-bold mt-40">
                    ...
                    @else
                        ...
                        <b class="mr-2 text-red-500 text-xl">A termék jelenleg nincs készleten. </b>
                    @endif
                  </span>
                </div>
              </div>
